...
contains 
  ...
  subroutine smag_damp_run(block, dt, state)
    ...
    call fill_halo_member(block, state%tension_h, full_lon=.true., full_lat=.true., full_lev=.true.)
    ...
    call fill_halo_member(block, state%shear_h, full_lon=.false., full_lat=.false., full_lev=.true.)
    ...
    call fill_halo_member(block, state%kmh, full_lon=.true., full_lat=.true., full_lev=.true.)
    ...
    call fill_halo_member(block, state%kmh_vtx, full_lon=.false., full_lat=.false., full_lev=.true.)
    ...
    call fill_halo_member(block, state%kmh_lon, full_lon=.false., full_lat=.true., full_lev=.true.)
    ...
    call fill_halo_member(block, state%kmh_lat, full_lon=.true., full_lat=.false., full_lev=.true.)

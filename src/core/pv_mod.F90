...
contains
...
#endif
    call fill_halo_member(block, state%vor, full_lon=.false., full_lat=.false., full_lev=.true.)
  ...
  subroutine calc_pv_vtx(block, state)
    ...
    call fill_halo_member(block, state%pv, full_lon=.false., full_lat=.false., full_lev=.true.)
...
#else
    call fill_halo_member(block, state%dpv_lat_t, full_lon=.true., full_lat=.false., full_lev=.true., west_halo=.false., north_halo=.false.)
...
#else
    call fill_halo_member(block, state%dpv_lon_t, full_lon=.false., full_lat=.true., full_lev=.true., east_halo=.false., south_halo=.false.)
...
#else
    call fill_halo_member(block, state%pv_lat, full_lon=.true., full_lat=.false., full_lev=.true., west_halo=.false., north_halo=.false.)
...
#else
    call fill_halo_member(block, state%pv_lon, full_lon=.false., full_lat=.true., full_lev=.true., east_halo=.false., south_halo=.false.)
  ...
  subroutine calc_pv_edge_apvm(block, state, dt)
    ...
    type(mesh_type), pointer :: mesh
    real(r8) u(member_num), v(member_num)
    integer i, j, k
